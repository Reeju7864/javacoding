...
body {
	...
	padding: 0;
	background-image:
		url("http://localhost:8080/Hotel_Project/images/hotel2.jpg");
...
<body>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item active"><a class="nav-link "
					href="http://localhost:8080/Hotel_Booking_System/admin/Home.jsp">Home</a>
				</li>
				<li class="nav-item dropdown"><a
					...
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						<li><a class="dropdown-item"
							href="http://localhost:8080/Hotel_Project/admin/AddHotel.jsp">Add
								Hotel</a></li>
						<li><a class="dropdown-item"
							href="http://localhost:8080/v/admin/HotelList.jsp">Hotel
								List</a></li>
					</ul></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					...
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						<li><a class="dropdown-item"
							href="http://localhost:8080/Hotel_Project/admin/AddUser.jsp">Add
								Users</a></li>
						<li><a class="dropdown-item"
							href="http://localhost:8080/Hotel_Project/admin/UserList.jsp">User
								List</a></li>
					</ul></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-bs-toggle="dropdown" aria-expanded="false">
						Booking </a>
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						<li><a class="dropdown-item" href="/gotoBookingList">Booking
								List</a></li>
					</ul></li>
			...
			<div class="col-md-8">
				...
				<form action="../UpdateHotel" method="post">
					<div class="row mb-3">
						...
						<div class="col">
							...
							<input type="text" class="form-control"
								...
								value="<%=hotel.getMobile()%>" name="contact">
						</div>
					</div>
					<div class="row mb-3">
						<div class="col">
					...
					<div class="row mb-3">
						...
						<div class="col">
							<label for="totalRooms" class="form-label">Total No. of
								Rooms :</label> <input type="number" class="form-control"
								placeholder="Enter Total No. of Rooms" required
								value="<%=hotel.getTotalNoOfRoom()%>" name="totalRooms">
						</div>
					</div>
					<div class="row mb-3">
						<div class="col">
							<label for="bookedRooms" class="form-label">No. of Booked
								Rooms :</label> <input type="text" class="form-control"
								placeholder="Enter No. of Booked Rooms" required
								value="<%=hotel.getNoOfBookedRoom()%>" name="bookedRooms">
						</div>
	...
	<center style='color: red;'>
		<h2>Error While Fetching Hotel details. Verify Hotel Id.</h2>
	</center>
	<%
	}
	%>
