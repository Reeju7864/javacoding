...
<script>
	...
	window.onpageshow = function(event) {
		...
		if (event.persisted) {
			...
			window.location.replace('/Hotel_Project	/user/Login.jsp');
		}
	};
</script>
</head>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item active"><a class="nav-link "
					href="http://localhost:8080/Hotel_Project/index.jsp">Home</a>
				</li>
				<li class="nav-item"><a class="nav-link "
					href="http://localhost:8080/Hotel_Project/user/SignUp.jsp">SignUp</a>
				</li>
				<li class="nav-item"><a class="nav-link "
					href="http://localhost:8080/Hotel_Project/user/Login.jsp">Login</a>
				</li>
			</ul>
		</div>
	</nav>
