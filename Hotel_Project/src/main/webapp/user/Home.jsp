...
<body>
	<nav class="navbar navbar-expand-lg navbar-light navbar-expand-md">
		<a href="" class="navbar-brand" style="color: white;"> <img
			...
			width="50px" style="border-radius: 10px;" alt="No img">HotelBooking
			System
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item active"><a class="nav-link "
					href="/Hotel_Project/user/Home.jsp">Home</a></li>
				<li class="nav-item"><a class="nav-link "
					href="/Hotel_Project/user/HotelList.jsp">Hotels</a></li>
				<li class="nav-item"><a class="nav-link "
					href="/Hotel_Project/user/BookingHistory.jsp">Booking
						History</a></li>
				<li class="nav-item"><a class="nav-link "
					href="/Hotel_Project/user/Payment.jsp">Payment</a></li>
			</ul>
		</div>
	...
	<!-- Home page -->
	<%
	String message2 = request.getParameter("msg");
	if (message2 != null) {
	%>
	<center>
		<h2 style='color: limegreen'>Login Successful!!!</h2>
	</center>
	<%
	}
	%>
